...
function percentageChange($old, $new, int $precision = 1){
    ...
    if ($change < 0 ){
        return '<span class="inline-flex items-center leading-none ml-2 text-[var(--tblr-red)] text-[10px] bg-[rgba(var(--tblr-red-rgb),0.15)] px-[5px] py-[3px] rounded-[3px]">
        ...
        return '<span class="inline-flex items-center leading-none ml-2 text-[var(--tblr-green)] text-[10px] bg-[rgba(var(--tblr-green-rgb),0.15)] px-[5px] py-[3px] rounded-[3px]">
