		...
		<div class="row g-2 align-items-center">
			...
			<div class="col-auto ms-auto d-print-none">
				<div class="btn-list">
					...
					<a href="#" class="btn btn-primary d-sm-none btn-icon" data-bs-toggle="modal" data-bs-target="#modal-report" aria-label="{{__('New')}}">
						<svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 5l0 14" /><path d="M5 12l14 0" /></svg>
					</a>
				</div>
			</div>
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<h3 class="flex items-center">
							${{ number_format(cache('total_sales')) }}
							<span class="inline-flex items-center leading-none ml-2 text-[var(--tblr-green)] text-[10px] bg-[rgba(var(--tblr-green-rgb),0.15)] px-[5px] py-[3px] rounded-[3px]">
						...
						<table class="table table-vcenter">
							...
							<tr>
								...
								<td class="w-1" colspan="3">
									...
									/<span class="text-[var(--lqd-heading-color)] ml-1">{{@$order->plan->total_words ?? '-'}}</span>
									/<span class="text-[var(--lqd-heading-color)] ml-1">{{@$order->plan->total_images ?? '-'}}</span>
								</td>
							</tr>
							@endforeach
