						...
						<div class="row">
							<div class="col-md-12 col-xl-12">
								...
								<div class="row">
									<div class="col-md-6">
										<div class="mb-3">
											...
											<input type="number" class="form-control" id="price" name="price" value="{{isset($subscription) ? $subscription->price : null}}" required>
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-md-12">
										<div class="mb-3">
											<label class="form-label">{{__('Paystack Plan Code')}}</label>
											<input type="text" name="paystack_plan_code" id="paystack_plan_code" class="form-control"  value="{{isset($subscription) ? $subscription->paystack_plan_code : null}}"/>
										</div>
									</div>
									<div class="col-md-12">
										<div class="mb-3">
									...
									<div class="col-md-6">
										<div class="mb-3">
											...
											<select class="form-select" id="ai_name" name="ai_name" required>
												@if(isset($subscription))
													<option value="{{$subscription->ai_name}}" selected>{{$subscription->ai_name}}</option>
												@endif
													<option value="text-ada-001">Ada {{__('(Cheapest &amp; Fastest')}})</option>
													<option value="text-babbage-001">Babbage</option>
													<option value="text-curie-001">Curie</option>
													<option value="text-davinci-003">Davinci {{__('(Most Expensive &amp; Most Capable)')}}</option>
													<option value="gpt-3.5-turbo">ChatGPT {{__('(New)')}}</option>
											</select>
										</div>
									</div>
									<div class="col-md-6">
