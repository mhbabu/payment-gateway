						...
						<div class="row">
							<div class="col-md-12">
								<div class="mb-3">
									...
									<input type="text" class="form-control" id="openai_api_secret" name="openai_api_secret" value="{{$setting->openai_api_secret}}">
								</div>
							</div>
							...
							<div class="col-md-12">
								<div class="mb-3">
									...
									<select class="form-select" name="openai_default_model" id="openai_default_model">
										...
										-->
										<option value="text-davinci-003" {{$setting->openai_default_model == 'text-davinci-003' ? 'selected' : null}}>{{__('Davinci (Most Expensive &amp; Most Capable)')}}</option>
