...
<div class="page-body mt-2 relative after:h-px after:w-full after:bg-[var(--tblr-body-bg)] after:absolute after:top-full after:left-0 after:-mt-px">
	<div class="container-fluid">
		<div class="row">
			...
			<div data-filter="{{$item->filters}}" class="col-lg-4 col-xl-3 col-md-6 pt-8 pb-10 px-16 relative border-b border-solid border-t-0 border-l-0 border-[var(--tblr-border-color)] group max-xl:px-10">
				...
				<div>
					<h4 class="inline-block text-[17px] font-semibold mb-[0.85em] relative">
						{{$item->title}}
						<span class="inline-block align-bottom absolute top-1/2 left-[calc(100%+0.35rem)] -translate-y-1/2 -translate-x-1 opacity-0 transition-all group-hover:!opacity-100 group-hover:translate-x-0">
				...
				<div class="absolute top-0 left-0 w-full h-full transition-all z-2">
					...
					@else
						<a href="#" disabled="" class="bg-white pointer-events-none btn text-dark">
							{{__('No Tokens Left')}}
						</a>
					@endif
				</div>
