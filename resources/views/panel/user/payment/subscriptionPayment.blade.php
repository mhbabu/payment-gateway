                                    ...
                                    <div class="col-md-12 col-xl-12">
                                        ...
                                        <div class="text-end pt-2">
                                            <button type="submit" id="card-button" data-secret="{{ $intent->client_secret }}" class="btn btn-success">
                                                {{__('Pay')}} {{currency()->symbol}}{{number_format($plan->price)}} {{__('with')}}<img src="/images/payment/stripe.svg" height="29px" alt="Stripe">
                                            </button>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-sm-4 col-lg-4">
                    <div class="card card-md">
                        ...
                        <div class="card-body text-center">
                            ...
                            <div class="display-5 fw-bold my-3">{{currency()->symbol}}{{number_format($plan->price)}}</div>
