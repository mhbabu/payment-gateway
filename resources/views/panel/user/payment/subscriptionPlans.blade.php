...
@section('content')
    ...
    <div class="page-body pt-8">
        <div class="container-xl">
                       ...
                       @if($plan->is_featured == 1)
                        ...
                        <div class="card-body flex flex-col !p-[45px_50px_50px] text-center">
                            ...
                            <div class="text-center mt-auto">
                                <button class="paymentTypeModal btn rounded-md p-[1.15em_2.1em] w-full text-[15px] group-[.theme-dark]/body:!bg-[rgba(255,255,255,1)] group-[.theme-dark]/body:!text-[rgba(0,0,0,0.9)]" data-href="{{ LaravelLocalization::localizeUrl( route('dashboard.user.payment.subscription.payment', $plan->id) ) }}">{{__('Choose plan')}}</button>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-sm-6 col-lg-4 d-flex align-items-stretch">
                        <div class="card card-md w-full bg-[#f3f5f8] text-center border-0 text-heading group-[.theme-dark]/body:!bg-[rgba(255,255,255,0.02)]">
                            ...
                            <div class="card-body !p-[45px_50px_50px] d-flex flex-column text-center">
                                ...
                                <div class="text-center  mt-auto">
                                    <button class="paymentTypeModal btn rounded-md p-[1.15em_2.1em] w-full text-[15px] group-[.theme-dark]/body:!bg-[rgba(255,255,255,1)] group-[.theme-dark]/body:!text-[rgba(0,0,0,0.9)]" data-href="{{ LaravelLocalization::localizeUrl( route('dashboard.user.payment.prepaid.payment', $plan->id) ) }}">{{__('Buy')}}</button>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            @include('panel.user.payment.modal.modal')
        </div>
    </div>
@endsection
...
@push('script')
    <script type="text/javascript">
        $('.paymentTypeModal').click(function() {
            $('#popup').css('display', 'block');
            const url = $(this).attr('data-href');
            $('#popup').find('form').attr('action', url);
        });
        ...
        // $('body').on('click', '.payment-gateway', function(e){
        //   let url = $('#paymentGatewayForm').attr('action');
        //   url = url + '/' + $(this).val();
        //   $('#paymentGatewayForm').attr('action', url);
        // })
    </script>
@endpush
