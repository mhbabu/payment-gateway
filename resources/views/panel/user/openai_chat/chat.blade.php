...
@section('content')
                ...
                <div class="col">
                    <a href="{{ LaravelLocalization::localizeUrl(route('dashboard.index')) }}"
                       class="flex items-center page-pretitle">
                        <svg class="mr-2" width="8" height="10" viewBox="0 0 6 10" fill="currentColor"
	...
	<template id="chat_user_bubble">
		<div class="flex flex-row-reverse content-end mb-2 text-right lg:ml-auto lg:max-w-[50%] gap-[8px]">
	...
	<template id="chat_ai_bubble">
		<div class="flex content-start mb-2 lg:max-w-[50%] gap-[8px] group">
			...
			<div class="border-none rounded-[2em] mb-[7px] min-h-[44px] text-[#090A0A] relative before:content-[''] before:rounded-[2em] before:inline-block before:bg-[#E5E7EB] before:absolute before:inset-0 group-[&.loading]:before:animate-pulse-intense">
