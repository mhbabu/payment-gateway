<ul class="chat-list-ul list-none m-0 p-0 text-[14px] h-full overflow-auto">
    @foreach ($list as $entry)
		...
		id="chat_{{$entry->id}}">
			...
			<span class="absolute -translate-y-1/2 top-1/2 right-4">
				<button class="chat-item-update-title btn bg-[--tblr-body-bg] w-[28px] h-[28px] p-0 border-[1px] border-solid border-[--tblr-border-color] opacity-0 group-hover:!opacity-100 group-[&.edit-mode]:!opacity-100 group-[&.edit-mode]:bg-[--tblr-green]">
					<svg class="group-[&.edit-mode]:hidden" width="13" height="11" viewBox="0 0 13 11" fill="none" xmlns="http://www.w3.org/2000/svg">
						<path d="M1.5293 10.2941H4.15418L11.0445 3.7664C11.3926 3.43664 11.5881 2.98938 11.5881 2.52303C11.5881 2.05668 11.3926 1.60943 11.0445 1.27967C10.6964 0.949906 10.2243 0.764648 9.73205 0.764648C9.23979 0.764648 8.76769 0.949906 8.41961 1.27967L1.5293 7.80733V10.2941Z" stroke="black" stroke-width="1.15" stroke-linecap="round" stroke-linejoin="round"/>
						<path d="M8.23535 1.82349L10.4706 3.94113" stroke="black" stroke-width="1.15" stroke-linecap="round" stroke-linejoin="round"/>
					</svg>
