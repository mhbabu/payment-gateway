        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                ...
                <div class="col-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="{{ LaravelLocalization::localizeUrl( route('dashboard.user.openai.documents.all') ) }}" class="btn d-none d-sm-inline-block">
                            {{__('My Documents')}}
                        </a>
                        <a href="{{ LaravelLocalization::localizeUrl( route('dashboard.user.openai.list') ) }}" class="btn btn-primary d-none d-sm-inline-block">
                            ...
                            <div class="row">
								<div class="col-md-6">
									<div class="flex max-sm:flex-col max-sm:mb-4">
										<div class="px-9 pl-0 border-r border-solid border-t-0 border-b-0 border-l-0 border-[var(--tblr-border-color)] max-sm:border-b max-sm:border-r-0 max-sm:px-0 max-sm:pb-3 max-sm:mb-3">
											<p class="subheader">{{__('Words Left')}}</p>
											<p class="mt-2 h1">{{\Illuminate\Support\Facades\Auth::user()->remaining_words}}</p>
										</div>
										<div class="px-9 border-r border-solid border-t-0 border-b-0 border-l-0 border-[var(--tblr-border-color)] max-sm:border-b max-sm:border-r-0 max-sm:px-0 max-sm:pb-3 max-sm:mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3 progress progress-separated">
                                        ...
                                        @endif
                                        @if($total_documents != 0)
                                        <div class="progress-bar grow-0 shrink-0 basis-auto bg-info" role="progressbar" style="width: {{100*(int)$total_image_documents/(int)$total_documents}}%" aria-label="{{__('Images')}}"></div>
                                        @endif
                                    </div>
                                    <div class="row">
                                ...
                                @foreach(\Illuminate\Support\Facades\Auth::user()->favoriteOpenai as $entry)
                                      ...
                                      <span class="avatar w-[43px] h-[43px] [&_svg]:w-[20px] [&_svg]:h-[20px]" style="background: {{$entry->color}}">
                                          ...
                                          @endif
                                            ...
                                            <td class="td-truncate">
                                                <a href="{{ LaravelLocalization::localizeUrl( route('dashboard.user.openai.documents.all') ) }}" class="text-heading hover:no-underline">
