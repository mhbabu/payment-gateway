							...
							<div class="row">
								<div class="col-12 col-md-5">
									...
									<div class="flex items-center relative">
										<input id="ref-code" class="form-control h-10 bg-white border-0" type="text" disabled value="{{$setting->site_url}}/register?aff={{\Illuminate\Support\Facades\Auth::user()->affiliate_code}}">
										<button class="copy-aff-link btn flex items-center h-full absolute top-0 right-0 px-3 bg-transparent shadow-none hover:scale-125">
								...
								<div class="col-12 col-md-4 ml-auto text-center text-heading font-semibold max-md:-order-1 max-md:!text-left max-md:mb-3">
					...
					<div class="card text-heading">
						<div class="card-body flex flex-col py-6 px-8">
							...
							<ol class="list-none p-0 ml-0 mb-7">
								<li class="mb-[18px]">
									<span class="inline-flex items-center justify-center w-[26px] h-[26px] mr-[1em] bg-[rgba(var(--tblr-primary-rgb),0.2)] text-primary rounded-2xl">
							...
							<div class="flex items-center relative">
								<input class="form-control h-10" type="email" placeholder="Email address">
								<span class="flex items-center h-full absolute top-0 right-0 px-3">
