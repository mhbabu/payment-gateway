<?php
	...
	$classname = ['inline-flex', 'items-center', 'transition-all', 'duration-300', 'hover:scale-105', 'hover:shadow-lg',  'hover:border-black', 'hover:bg-black', 'hover:text-white'];
...
<a href="{{$link}}" class="{{ join( ' ', $classname ) }}">
