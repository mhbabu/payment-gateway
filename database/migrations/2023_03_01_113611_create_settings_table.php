...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('settings', function (Blueprint $table) {
            ...
            $table->string('invoice_winvoice_websiteebsite')->nullable();
            ...
            //PAYSTACK
            $table->boolean('paystack_active')->default(1);
            $table->string('paystack_private_key')->nullable();
            ...
            $table->string('default_country')->default('United States of America');
